...
name_product = ["клубники", "малины", "черники", "ежевики", "земляники",
                "винограда", "гранатов", "киви", "крыжовника", "лимонов",
...
while (i < number + 2):
    ...
    while (Otvet<0 or (Otvet>100) or (round(n-a*(b+c/1000) * 10 ** amount - int(float(n-a*(b+c/1000)) * 10 ** amount), 5) != 0)):
        a = random.randint(12, 20) * 5
